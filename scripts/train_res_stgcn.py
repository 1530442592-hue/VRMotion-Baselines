...
from models.resnet_stgcn import ResNetSTGCN
...
# =================配置区=================
DEVICE = get_device()
MODEL_NAME = "resnet_stgcn_100ep_fixed"
EPOCHS = 100
BATCH_SIZE = 16 # ResNet 轻量，16 或 32 一般没问题
...
model = ResNetSTGCN(seq_len=16, pred_len=16, num_joints=24).to(DEVICE)
