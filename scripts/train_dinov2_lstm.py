...
from models.dinov2_lstm import DINOv2LSTM
...
# =================模型初始化=================
logger.info("🧠 正在加载 DINOv2-Giant (11亿参数) + LSTM 模型...")
model = DINOv2LSTM(seq_len=16, pred_len=16, num_joints=24, use_8bit=False).to(DEVICE)
